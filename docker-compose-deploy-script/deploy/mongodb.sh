...
# 基础配置 (统一前缀: base_)
base_image_name="mongo:latest"
base_container_name="mongo"
base_install_path="/opt/server/mongo"
...
services:
  ${base_container_name}:
    ...
    volumes:
      - ${base_install_path}/data:/data/db
      - ${base_install_path}/logs:/var/log/mongodb
